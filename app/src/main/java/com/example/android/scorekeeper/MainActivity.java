...
public class MainActivity extends AppCompatActivity {
    ...
    int teamAFoulScore = 0;
    int teamAPenaltyScore = 0;
    int teamAYellowCardScore = 0;
    int teamARedCardScore = 0;

    int teamBGoalScore = 0;
    int teamBFoulScore = 0;
    int teamBPenaltyScore = 0;
    int teamBYellowCardScore = 0;
    int teamBRedCardScore = 0;
    ...
    public void displayFoulScoreForTeamA(int score) {
        TextView scoreView = (TextView) findViewById(R.id.team_a_faul_score);
        scoreView.setText(String.valueOf(score));
    }
    /**
    ...
    public void displayFoulScoreForTeamB(int score) {
        TextView scoreView = (TextView) findViewById(R.id.team_b_faul_score);
        scoreView.setText(String.valueOf(score));
    }
    /**
